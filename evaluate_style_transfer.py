...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        init_fn = slim.assign_from_checkpoint_fn("/data/jsy/code/avatar-net/pretrained_models/model.ckpt-120000",
                                                 slim.get_model_variables(), ignore_missing_vars=True)
        with tf.Session() as sess:
            ...
            for i in range(len(style_image_filenames)):
                ...
                for j in range(len(content_image_filenames)):
                    ...
                    output_filename = os.path.join(FLAGS.eval_dir, f'{content_label}_{style_label}.bmp')
